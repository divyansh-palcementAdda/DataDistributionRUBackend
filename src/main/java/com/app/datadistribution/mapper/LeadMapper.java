...
public interface LeadMapper {
    ...
    default LeadResponse toDto(Lead lead) {
        ...
        return LeadResponse.builder()
                ...
                .preferredStudyState(lead.getPreferredStudyState())
                .preferredStudyCity(lead.getPreferredStudyCity())
                .planningToVisitUniversity(lead.getPlanningToVisitUniversity())
                .visitDate(lead.getVisitDate())
                .visitTime(lead.getVisitTime())
